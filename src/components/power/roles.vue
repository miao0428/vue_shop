      ...
      <el-table :data="roleList" border stripe>
        ...
        <el-table-column type="expand">
          <template slot-scope="scope">
            <el-row
              :class="['bdbutton', i1 === 0 ? 'bdtop' : '', 'vcenter']"
        ...
        <el-table-column label="操作" width="300px">
          <template slot-scope="scope">
            <el-button
              @click="showEditDiaolg(scope.row.id)"
              size="mini"
              type="primary"
              icon="el-icon-edit"
              >编辑</el-button
  ...
  methods: {
   ...
   async removeUserById(id){
      // 弹窗询问是否删除数据
        ...
        // 如果用户确认啦删除，则返回字符串confirm
        // 如果用户取消啦删除，则返回字符串 cancel
